...
import * as mockDataProvider from 'Dumee-data-provider/react-query';
import type { TStartupConfig } from 'Dumee-data-provider';
...
jest.mock('Dumee-data-provider/react-query');

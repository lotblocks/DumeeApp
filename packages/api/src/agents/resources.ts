...
import { EModelEndpoint, EToolResources, AgentCapabilities } from 'dumee-data-provider';
import type { AgentToolResources, TFile, AgentBaseResource } from 'dumee-data-provider';
import type { FilterQuery, QueryOptions, ProjectionType } from 'mongoose';
import type { IMongoFile } from '@dumee/data-schemas';

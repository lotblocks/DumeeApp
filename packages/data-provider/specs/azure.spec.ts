...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'Dumee-westus'
    expect(groupMap).toHaveProperty('Dumee-westus');
    expect(groupMap['Dumee-westus']).toEqual(
    ...
    // Check groupMap for 'Dumee-eastus'
    expect(groupMap).toHaveProperty('Dumee-eastus');
    expect(groupMap['Dumee-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'Dumee-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'Dumee-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'Dumee-eastus',

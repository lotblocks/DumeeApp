...
(async () => {
  ...
  console.purple('Removing all tags for Dumee `deployed` images...');
  const repositories = ['ghcr.io/danny-avila/Dumee-dev-api', 'Dumee-client'];
  ...
  console.purple('Pulling latest Dumee images...');

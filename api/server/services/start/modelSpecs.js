const { EModelEndpoint } = require('dumee-data-provider');
const { normalizeEndpointName } = require('~/server/utils');
const { logger } = require('~/config');

/**
 * Sets up Model Specs from the config (`Dumee.yaml`) file.
...
For more information, see the documentation at https://dum.ee/docs/configuration/model_specs`);
      continue;
    }

const { Constants, EModelEndpoint, actionDomainSeparator } = require('dumee-data-provider');
...
jest.mock('~/cache/getLogStores', () => {
  return jest.fn().mockImplementation(() => {
    ...
    const { CacheKeys } = require('dumee-data-provider');
...
describe('domainParser', () => {
  ...
  it('handles unicode characters in domain names correctly when encoding', async () => {
    const unicodeDomain = 'tÃ¤st.example.com';

...
const { isEnabled, getUserMCPAuthMap } = require('@dumee/api');
const { CacheKeys, EModelEndpoint } = require('dumee-data-provider');
...
async function getCustomConfig() {
  ...
  return (await cache.get(CacheKeys.Dumee_YAML_CONFIG)) || (await loadCustomConfig());
}
 ...
 * @param {import('@dumee/data-schemas').PluginAuthMethods['findPluginAuthsByKeys']} params.findPluginAuthsByKeys

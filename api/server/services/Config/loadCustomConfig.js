...
const { loadYaml } = require('@dumee/api');
...
const defaultConfigPath = path.resolve(projectRoot, 'Dumee.yaml');
...
https://dum.ee/docs/configuration/stt_tts`);
      }
  ...
  if (customConfig.cache) {
    ...
    await cache.set(CacheKeys.Dumee_YAML_CONFIG, customConfig);
  }

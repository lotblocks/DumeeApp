const { Providers } = require('@dumee/agents');
const {
  primeResources,
  extractDumeeParams,
...
const initializeAgent = async ({
  ...
  const { resendFiles, maxContextTokens, modelOptions } = extractDumeeParams(_modelOptions);
  ...
  /** @type {import('@dumee/agents').GenericTool[]} */
  ...
  /** @type {import('@dumee/agents').ClientOptions} */

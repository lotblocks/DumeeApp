...
const { CacheKeys, defaultSocialLogins, Constants } = require('dumee-data-provider');
...
router.get('/', async function (req, res) {
  ...
  try {
    ...
    /** @type {TStartupConfig} */
    const payload = {
      appTitle: process.env.APP_TITLE || 'Dumee',
      ...
      helpAndFaqURL: process.env.HELP_AND_FAQ_URL || 'https://Dumee.ai',

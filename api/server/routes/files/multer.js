...
const { sanitizeFilename } = require('@dumee/api');
const { fileConfig: defaultFileConfig, mergeFileConfig } = require('dumee-data-provider');
...
/**
 *
 * @param {import('dumee-data-provider').FileConfig | undefined} customFileConfig
 */
